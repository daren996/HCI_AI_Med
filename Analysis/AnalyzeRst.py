...
#     print(r)
rank_show = 30
rank_dgn = rank_dgn[0:rank_show] + [('else', sum([dgn[1] for dgn in rank_dgn[rank_show:]]))]
# for r in rank_dgn:
#     print(r)
...
#     print(sym)
rank_show = 10
rank_sym = rank_sym[0:rank_show] + [('else', sum([sym[1] for sym in rank_sym[rank_show:]]))]
# for sym in rank_sym:
#     print(sym)
...
# ax3.pie([dgn[1] for dgn in rank_dgn], labels=labels3, explode=[0] * rank_show + [0.1], shadow=True)
# fig2.savefig('diagnoses_info.jpg')
...
ax4.pie([sym[1] for sym in rank_sym], labels=labels4, explode=[0] * rank_show + [0.1], shadow=True)
fig3.savefig('symptoms_info.jpg')
